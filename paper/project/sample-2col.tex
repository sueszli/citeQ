...
%%
%% The "title" command
\title{CiteQ: Citation Quality Assessment for Scientific Papers through LLM}

%%
%% The "author" command and its associated commands are used to define
%% the authors and their affiliations.
\author[1]{Yahya Jabary}[%
email=jabaryyahya@gmail.com,
url=https://example.com/,
]
\cormark[1]

\author[1]{Onur Eren Arpacı}[%
orcid=0000-0001-7116-9338,
email=mail@example.com,
url=https://example.com/,
]
\address[1]{University of Waterloo, Ontario, Waterloo, Canada}
